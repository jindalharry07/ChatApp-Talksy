  ...
  return selectedUser ? (
    ...
    { /*-----------header---------*/}
      ...
      {messagesDummyData.map((msg,index)=>(
        ...
        {msg.image ? (
          <img src={assets.img2} alt=''  className='max-w-[230px] border border-gray-700 rounded-lg overflow-hidden mb-8'/>
         ):(
    ...
    { /* ----------Bottom Area --------------*/}
    <div className='absolute bottom-0 left=0 right=0 w-full flex items-center gap-3 p-3'>
